...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2022 at 12:55 AM
...
INSERT INTO `detectors` (`id`, `Brand`, `type`) VALUES
(1, 'samsung', 'Face'),
(2, 'test', 'incendie'),
(3, 'sony', 'son'),
(9, 'h', 'son');
...
INSERT INTO `users` (`id`, `email`, `password`, `name`, `familyname`, `accountType`) VALUES
